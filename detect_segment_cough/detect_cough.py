...
import os
import sys
sys.path.append(os.path.abspath('/home/kolaj/my_project/AI/Kaszlometr final/detect_segment_cough/src'))
...
def main(input_file):
    ...
    model = pickle.load(open(os.path.join('./detect_segment_cough/models', 'cough_classifier'),
        'rb'))
    scaler = pickle.load(open(os.path.join('./detect_segment_cough/models',
